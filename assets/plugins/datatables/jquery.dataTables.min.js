      ...
      G = function (a) {
        if (c === k || c === i)
          ((j = m[i]),
            ...
            j && j._bAttrSrc
              ? (N(j.mData._)(d, l), u(j.mData.sort, a), u(j.mData.type, a), u(j.mData.filter, a))
              : q
      ...
      if (0 !== i.length) {
        ...
        for (j = j ? 0 : g; j < f; j++) {
          ...
          if (0 !== e) {
            var G = d[c % e];
            q._sRowStripe != G &&
              (h(u).removeClass(q._sRowStripe).addClass(G), (q._sRowStripe = G));
          }
    ...
    for (var f = a.sDom.split(""), g, j, i, l, m, q, k = 0; k < f.length; k++) {
      ...
      if ("<" == j) {
        ...
        if ("'" == l || '"' == l) {
          ...
          -1 != m.indexOf(".")
            ? ((l = m.split(".")), (i.id = l[0].substr(1, l[0].length - 1)), (i.className = l[1]))
            : "#" == m.charAt(0)
    ...
    if (h.isArray(a)) for (var c = 0, d = a.length; c < d; c++) r.register(a[c], b);
      ...
      for (var e = a.split("."), f = Tb, g, j, c = 0, d = e.length; c < d; c++) {
        ...
        c === d - 1
          ? ((i.val = b),
            (i.type =
              "function" === typeof b ? "function" : h.isPlainObject(b) ? "object" : "other"))
