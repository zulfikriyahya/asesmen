...
class Kelasnilai extends CI_Controller
{
    ...
    public function loadNilaiMapel()
    {
        ...
        $arrBulan = $smt == '1' ? ['07', '08', '09', '10', '11', '12'] : ['01', '02', '03', '04', '05', '06'];
        ...
        foreach ($arrBulan as $bulan) {
            foreach ($infos as $info) {
                ...
                foreach ($dates as $date) {
                    ...
                    $jadwal_materi[$b][$t][$info->jam_ke][1] = isset($jj[$mapel][$info->jam_ke][1]) ? $jj[$mapel][$info->jam_ke][1] : null;
                    $jadwal_materi[$b][$t][$info->jam_ke][2] = isset($jj[$mapel][$info->jam_ke][2]) ? $jj[$mapel][$info->jam_ke][2] : null;
                    $cols++;
                }
            }
        }

        $this->output_json(['mapels' => []]);
    }
