...
class Useradmin extends CI_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data = ['status' => true, 'msg' => 'User berhasil dibuat.'];
        }
    ...
    public function edit_status()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            $data = ['status' => false, 'errors' => ['status' => form_error('status')]];
        } else {
            $id     = $this->input->post('id', true);
    ...
    public function edit_level()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            $data = ['status' => false, 'errors' => ['level' => form_error('level')]];
        } else {
            $id     = $this->input->post('id', true);
    ...
    public function deleteFile()
    {
        ...
        if (!unlink($file_name)) {
            $this->output_json(['status' => false, 'msg' => 'Gagal menghapus file.']);
        } else {
            $this->output_json(['status' => true, 'msg' => 'File berhasil dihapus.']);
        }
    }
    ...
    public function saveProfile()
    {
        ...
        $insert = [
            ...
            'foto'         => str_replace(base_url(), '', $this->input->post('foto') ?? ''),
        ];
        $update       = $this->db->replace('users_profile', $insert);
        $res['status'] = (bool) $update;
